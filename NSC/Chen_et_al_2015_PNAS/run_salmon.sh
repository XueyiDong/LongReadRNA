...
/wehisan/home/allstaff/d/dong.x/Programs/salmon/bin/salmon quant -i $annodir/transcript_assembly.index -l A -1 $datadir/NPC_RNA_$SAMPLE\_L004_R1.fastq.gz -2 $datadir/NPC_RNA_$SAMPLE\_L004_R2.fastq.gz --validateMappings -o $datadir/salmon/$SAMPLE
done