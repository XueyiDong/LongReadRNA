...
DATA_DIR=$SEQUINS_DIR/20200228_YPRDP_2xsequin_mixAB/sequins_rebasecall/pass/merged/downsample
OUT_DIR=/wehisan/home/allstaff/d/dong.x/analysis/2020/smchd1/sequins/talon_downsample

mkdir -p $OUT_DIR/sam

# map
minimap2 -ax splice --MD -c $SEQUINS_DIR/annotations/rnasequin_decoychr_2.4.fa $DATA_DIR/barcode01.fq.gz > $OUT_DIR/sam/barcode01.sam
minimap2 -ax splice --MD -c $SEQUINS_DIR/annotations/rnasequin_decoychr_2.4.fa $DATA_DIR/barcode02.fq.gz > $OUT_DIR/sam/barcode02.sam
minimap2 -ax splice --MD -c $SEQUINS_DIR/annotations/rnasequin_decoychr_2.4.fa $DATA_DIR/barcode03.fq.gz > $OUT_DIR/sam/barcode03.sam
minimap2 -ax splice --MD -c $SEQUINS_DIR/annotations/rnasequin_decoychr_2.4.fa $DATA_DIR/barcode04.fq.gz > $OUT_DIR/sam/barcode04.sam
# # ------------------------
# # convert to bam
...
module load R
python $TALON_WF/TranscriptClean/TranscriptClean.py --sam $OUT_DIR/sam/barcode01.sam --genome $SEQUINS_DIR/annotations/rnasequin_decoychr_2.4.fa --outprefix $OUT_DIR/sam/barcode01
Rscript $TALON_WF/TranscriptClean/generate_report.R $OUT_DIR/sam/barcode01
python $TALON_WF/TranscriptClean/TranscriptClean.py --sam $OUT_DIR/sam/barcode02.sam --genome $SEQUINS_DIR/annotations/rnasequin_decoychr_2.4.fa --outprefix $OUT_DIR/sam/barcode02
Rscript $TALON_WF/TranscriptClean/generate_report.R $OUT_DIR/sam/barcode02
python $TALON_WF/TranscriptClean/TranscriptClean.py --sam $OUT_DIR/sam/barcode03.sam --genome $SEQUINS_DIR/annotations/rnasequin_decoychr_2.4.fa --outprefix $OUT_DIR/sam/barcode03
Rscript $TALON_WF/TranscriptClean/generate_report.R $OUT_DIR/sam/barcode03
python $TALON_WF/TranscriptClean/TranscriptClean.py --sam $OUT_DIR/sam/barcode04.sam --genome $SEQUINS_DIR/annotations/rnasequin_decoychr_2.4.fa --outprefix $OUT_DIR/sam/barcode04
Rscript $TALON_WF/TranscriptClean/generate_report.R $OUT_DIR/sam/barcode04
conda deactivate
# # run TALON
