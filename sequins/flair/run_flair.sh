...
# align
python $flairdir/flair.py align -g $anno/rnasequin_decoychr_2.4.fa -r $reads/barcode01.fq.gz $reads/barcode02.fq.gz $reads/barcode03.fq.gz $reads/barcode04.gz -t 8 -v1.3
...
# # collapse
python $flairdir/flair.py collapse -g $anno/rnasequin_decoychr_2.4.fa -f $anno/rnasequin_annotation_2.4.gtf -r $reads/barcode01.fq.gz $reads/barcode02.fq.gz $reads/barcode03.fq.gz $reads/barcode04.gz -q flair_all_corrected.bed -t 8 --temp_dir ./tmp
